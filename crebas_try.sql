...
ALTER TABLE `category`     AUTO_INCREMENT =  1073741825 ; -- [1073741825 , 2147483648]
ALTER TABLE `admin`        AUTO_INCREMENT =  805306369  ; -- [805306369  , 1073741824]
ALTER TABLE `config`       AUTO_INCREMENT =  536870913  ; -- [536870913  , 805306368 ]
ALTER TABLE `tag`          AUTO_INCREMENT =  268435457  ; -- [268435457  , 536870912 ]
ALTER TABLE `circle`       AUTO_INCREMENT =  201326593  ; -- [201326593  , 268435456 ]
ALTER TABLE `user`         AUTO_INCREMENT =  134217729  ; -- [134217729  , 201326592 ]
ALTER TABLE `article`      AUTO_INCREMENT =  67108865   ; -- [67108865   , 134217728 ]
ALTER TABLE `message`      AUTO_INCREMENT =  66060289   ; -- [66060289   , 67108864  ]
ALTER TABLE `comment`      AUTO_INCREMENT =  66043905   ; -- [66043905   , 66060288  ]
ALTER TABLE `notice`       AUTO_INCREMENT =  66027521   ; -- [66027521   , 66043904  ]
ALTER TABLE `dynamic`      AUTO_INCREMENT =  66011137   ; -- [66011137   , 66027520  ]
